...
import com.src.jpa.Client;
import com.src.jsf.util.JsfUtil;
import com.src.jsf.util.PaginationHelper;
import com.src.session.ClientFacade;
...
public class ClientController implements Serializable {
    ...
    @EJB
    private com.src.session.ClientFacade ejbFacade;
    ...
    public static class ClientControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Client) {
                ...
                return getStringKey(o.getPrenom());
            } else {
